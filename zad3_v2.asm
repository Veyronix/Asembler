...
PETLA_X_WIEKSZE_Y_i_XDOD_YDOD:
	...
	;----------------------------
	cmp ds:[tmpx],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YDOD
	
	cmp word ptr ds:[y],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YDOD
	cmp ds:[tmpx],320d
	ja ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YDOD
	
	cmp word ptr ds:[y],200d
	ja ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YDOD
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YDOD:
	dec ds:[tmpx]
...
PETLA_X_WIEKSZE_Y_i_XDOD_YUJ:
	...
	;----------------------------
	cmp ds:[tmpx],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YUJ
	
	cmp word ptr ds:[y],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YUJ
	cmp ds:[tmpx],320d
	ja ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YUJ
	
	cmp word ptr ds:[y],200d
	ja ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YUJ
;--------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_WIEKSZE_Y_i_XDOD_YUJ:
	dec ds:[tmpx]
	mov ax,word ptr ds:[tmpx]
	cmp ax,ds:[x2]
...
;----------------------------
	cmp ds:[tmpx],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YDOD
	
	cmp word ptr ds:[y],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YDOD
	cmp ds:[tmpx],320d
	ja ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YDOD
	
	cmp word ptr ds:[y],200d
	ja ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YDOD
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YDOD:
	inc ds:[tmpx]
	mov ax,word ptr ds:[tmpx]
	cmp ax,ds:[x2]
...
;----------------------------
	cmp ds:[tmpx],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YUJ
	
	cmp word ptr ds:[y],0
	jb ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YUJ
	cmp ds:[tmpx],320d
	ja ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YUJ
	
	cmp word ptr ds:[y],200d
	ja ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YUJ
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_WIEKSZE_Y_I_XUJ_YUJ:
	inc ds:[tmpx]
	mov ax,word ptr ds:[tmpx]
	cmp ax,ds:[x2]
...
;----------------------------
	...
	cmp ds:[tmpy],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YDOD
	
	cmp word ptr ds:[x],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YDOD
	cmp word ptr ds:[x],320d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YDOD
	
	cmp ds:[tmpy],200d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YDOD
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YDOD:
	dec ds:[tmpy]
...
;----------------------------
	cmp ds:[tmpy],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YUJ
	
	cmp word ptr ds:[x],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YUJ
	cmp word ptr ds:[x],320d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YUJ
	
	cmp ds:[tmpy],200d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YUJ
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_MNIEJSZE_Y_i_XDOD_YUJ:
	inc ds:[tmpy]
	mov ax,word ptr ds:[tmpy]
	cmp ax,ds:[y2]
...
;----------------------------
	cmp ds:[tmpy],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YDOD
	
	cmp word ptr ds:[x],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YDOD
	cmp word ptr ds:[x],320d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YDOD
	
	cmp ds:[tmpy],200d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YDOD
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YDOD:
	dec ds:[tmpy]
	mov ax,word ptr ds:[tmpy]
	cmp ax,ds:[y2]
...
;----------------------------
	cmp ds:[tmpy],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YUJ
	
	cmp word ptr ds:[x],0
	jb ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YUJ
	cmp word ptr ds:[x],320d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YUJ
	
	cmp ds:[tmpy],200d
	ja ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YUJ
	;------------------------
	call ZAMALUJ_PUNKT
ZA_PULPITEM_X_MNIEJSZE_Y_i_XUJ_YUJ:
	inc ds:[tmpy]
	mov ax,word ptr ds:[tmpy]
	cmp ax,ds:[y2]
